...
namespace Microsoft.Samples.ServiceHosting.AspProviders
{
    public static class CloudConfiguration
    {
        ...
        internal static readonly string DefaultStorageConfigurationString = "AzureStorage.ConnectionString";
        ...
        public static string GetLocalStoragePath(string localResourceName)
        {
